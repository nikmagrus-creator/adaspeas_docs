# Контекст проекта Adaspeas (бот + автодеплой) — актуально на 2026-02-03 18:10 UTC

Актуально на: 2026-02-03 18:10 UTC
...
Опционально:
- добавить редирект в Caddy: redir / /health 302
или
...
| 2026-02-03 18:10 UTC | Nikolay | doc/ops | Уточнено правило “пушим сразу в main”, синхронизированы таймстемпы, добавлена карта проекта в README | закрепление процесса | |
