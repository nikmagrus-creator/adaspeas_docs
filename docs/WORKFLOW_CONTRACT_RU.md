...
- Архивы (.zip) и инкрементальные pack (.tar.gz) **не кладём** в корень репозитория: храним в папке скачивания паков.
...
|---|---|---|---|---|
| 2026-02-07 18:30 MSK | ChatGPT | docs | Добавлено правило: не класть архивы/паки в корень репозитория (фикс через .gitignore + указание в контракте) | |
