...
При этом таймстемпы в документах и таблицах “История изменений” фиксируем в **UTC** (как в CI),
а при необходимости можем дублировать MSK в скобках.
...
- ADR должен содержать дату/время UTC, статус, контекст, решение, последствия.
...
| 2026-02-05 00:00 UTC | ChatGPT | contract | Переписан контракт под автономную разработку ассистентом: CHATLOG/ADR/CHANGELOG, инкрементальные пакеты, требования к командам | |
