...
Актуально на: 2026-02-09 13:10 MSK
...
- Если ассистент пишет «доделаю/продолжу в следующем сообщении» и **не выдал pack/результат**, то при сообщении пользователя «далее» ассистент обязан **продолжить ту же задачу**, пока не выдаст pack/результат (или явно не остановит работу с причиной).
